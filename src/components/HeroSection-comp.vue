<template>
    ...
    <div class="h-max min-h-[600px] w-full bg-[#30342D] relative max-w-[1600px] overflow-hidden">
        ...
        <div class="absolute top-[40%] left-[5rem]">
            ...
            <h3 class="text-white/[0.7] text-sm lg:text-xl pt-2 lg:pt-5 w-[370px] lg:w-[600px] font-Poppins font-normal">En casual airsoft og hardcore milsim foreningen med med stort fokus på trivsel, og kammarat skab, hvor der er plads til alle... Kom frisk soldat!</h3>

            <div class="absolute bottom-[-60px] left-[50px] lg:bottom-[-60px] lg:left-[100px]">
                <img class="w-fit h-[300px] lg:h-[400px] opacity-10" alt="CARDlogo-white" src="@/assets/cardlogo_whiteout.svg"/>
            </div>
